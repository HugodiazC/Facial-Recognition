...
#img= np.zeros((512,512)) #zeros son negros los unos son blanco
#Resultado de esto imagen completamente negra.

#img2= np.zeros((512,512,3),np.uint8) #imagen a color
#img3= np.zeros((512,512,3),np.uint8)
img4= np.zeros((512,512,3),np.uint8)
#print(img2)
#img2[:]=255,0,0 #Pintar de azul
#img3[200:300,100:300]=255,0,0 #Pintar de azul
